...
public class DebugFifteen4 extends JFrame
{
   ...
   public DebugFifteen4()
   {
      ...
      animal.addActionListener(this::actionPerformed);
      song.addActionListener(this::actionPerformed);
      flower.addActionListener(this::actionPerformed);
      milwaukee.addActionListener(this::actionPerformed);
      madison.addActionListener(this::actionPerformed);
      add(label1);
